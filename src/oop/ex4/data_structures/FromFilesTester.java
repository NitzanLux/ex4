...
public class FromFilesTester {
    ...
    private static final String DEFAULT_PATH = "src/oop/ex4/data_structures/tests";   // DEFAULT PATH
    /////////// PRINT TREE RELATED:
    // ROOT OF TREE RELATED:
    private static final String TREE_ROOT_VARIABLE_NAME = "root"; // What is the name of the variable that holds the root tree?
    private static final String ROOT_OF_TREE_VARIABLE_LOCATION = "BinaryTree";  //  In what class is the variable declared? Father of AvlTree? in AvlTree?
    // NODE OF TREE RELATED:
    private static final String NODE_CLASS_NAME = "BinaryTreeNode";  // Name of the class you are using for the Nodes in the tree
    private static final String GET_LEFT_VARIABLE_NAME = "leftChild";  // Name of the variable you are using to to hold left node
    private static final String GET_RIGHT_VARIABLE_NAME = "rightChild";  // Name of the variable you are using to to hold right node
